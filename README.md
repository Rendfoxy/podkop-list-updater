...
Материалы этого репозитория распространяются по лицензии `CC BY-NC 4.0`.

Это значит:

- использовать, копировать и адаптировать материалы можно свободно
- при использовании нужно указывать источник
- использовать материалы в коммерческих целях без отдельного письменного разрешения нельзя
